                ...
                <div className="max-w-md text-left">
                    <div className="flex items-center mb-4">
                        ...
                        <Image
                            ...
                            width={110}
                            height={110}
                            className="rounded-full w-32 h-32 border-4 border-white mr-6"
                        />
                    </div>
                    ...
                    <p className="text-xl mb-2">
                        ...
                        <a href="https://ftqapp.com" rel="noopener noreferrer" target="_blank" className={LINK_STYLE}>
                            First Time Quality.
                        </a>
                    </p>
                    <p className="text-xl mb-2">
                    ...
                    <div className="flex mt-8 items-center mb-4 space-x-2">
                        <a href="mailto:wkoury@hey.com" className={LINK_STYLE}>
                            Email
                        </a>
                        <a href="https://github.com/wkoury" className={LINK_STYLE}>
                            Github
                        </a>
                    </div>
                </div>
